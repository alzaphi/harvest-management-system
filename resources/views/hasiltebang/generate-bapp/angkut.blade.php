...
@section('page-title', 'BAPP Angkut - ' . $vendor->nama_vendor)
...
<div class="bapp-container">
    <div class="bapp-header">
        <div class="bapp-title">BERITA ACARA PEMERIKSAAN PENERIMAAN KAYU</div>
        <div class="bapp-subtitle">(BAPP Angkut)</div>
    </div>
